...
from toolbox.file_tools import read_inputs, get_output_file_name, \
    write_config_string
from toolbox.flat_models import SirFlatRandomWalk, \
    sir_flat_random_walk_get_parameters
import numpy as np
import sys
import datetime
...
def main():
    ...
    out_file_name = get_output_file_name(std_name="output_flat_sir.out")

    # Creates an SIR-model instance.
    model = SirFlatRandomWalk(*sir_flat_random_walk_get_parameters(input_dict))
